...
import DynamicForm1 from '../pages/dynamicForm1';
...
export default function IndexPage() {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    {
      title: '字段别名',
      dataIndex: 'filed_alias',
      key: 'filed_alias',
      width: '10%',
    },
    {
      title: '字段类型',
      dataIndex: 'filed_type',
      key: 'filed_type',
      width: '10%',
    },
    {
  ...
  const handleFilter = () => {
    const filteredResults = dataSource.filter((item) =>
      item.field_name.toLowerCase().includes(searchText.toLowerCase()),
    );
            ...
            <Col>
              ...
              >
                <Button
                  ...
                  style={{ backgroundColor: '#FACD91', color: '#fff' }}
                >
                  返回
                </Button>
              </Form.Item>
